...
<div class="row" style="color:white;">
	...
	<div class="col-md-3">
		<ul class="list-unstyled">
			...
			<li><a href="#" style="float: right;">登入</a></li>
		</ul>
	</div>
</div>
</div>
	...
	<div class="container">
		...
		<div class="col-md-10">
			<div class="panel panel-primary">
				<div class="panel-heading" style="font-size:20px">登入帳號</div>
					<form action="login2.jsp" method="POST" id="form1"style="text-align:center;vertical-align:middle">
						...
						<button class="btn btn-primary btn-lg" type="submit" form="form1" onclick="window.location='index.jsp';" id="subbtn"style="margin-left:10px;width:100px">返回</button>
					</form>
